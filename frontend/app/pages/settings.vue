...
const providers = ['agnesai', 'ali', 'chatfire', 'gemini', 'minimax', 'openai', 'openrouter', 'vidu', 'volcengine']
...
const providerPresets = {
  text: {
    agnesai: { label: 'Agnes AI', baseUrl: 'https://apihub.agnes-ai.com', models: ['gemini-3-pro-preview'] },
  ...
  image: {
    agnesai: { label: 'Agnes AI', baseUrl: 'https://apihub.agnes-ai.com', models: ['dall-e-3'] },
  ...
  video: {
    agnesai: { label: 'Agnes AI', baseUrl: 'https://apihub.agnes-ai.com', models: ['agnes-video-v2.0'] },
